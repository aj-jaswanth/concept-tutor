		...
		if (GUILayout.Button("Ok"))
		{
			...
			else
			{
				...
				if(flag==0)
				{
					...
					village_non_drag_component.name = "bridge";
					village_non_drag_component.image = "bridge";
					village_non_drag_component.icon = "bridge_icon";
					SceneManager.village_non_drag_components_list.push(village_non_drag_component);
					SceneManager.village_component_unlocked = "bridge";
